...
SimpleForm.setup do |config|
  ...
  config.wrappers :default, tag: 'div', class: 'govuk-form-group', error_class: 'govuk-form-group--error' do |b|
    ...
    ## Inputs
    b.use :label, class: 'govuk-label govuk-label--s'
  ...
  config.wrappers :inline_checkbox, :tag => 'div',
    ...
    checkbox.wrapper :class => 'govuk-checkboxes__item' do |field|
      ...
      field.use :label_text, wrap_with: { tag: 'label', class: 'govuk-label govuk-label--s govuk-checkboxes__label' }
    end
  ...
  config.wrappers :money, tag: 'div',
    ...
    field.use :input, class: 'form-control govuk-input', pattern: '\d*'
  end
  ...
  config.generate_additional_classes_for = %i[group input]
  ...
  # config.input_class = 'form-control form-control-3-4'
